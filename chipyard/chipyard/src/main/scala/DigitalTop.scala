...
import chipyard.GCDmod.CanHavePeripheryGCDmod
import chipyard.dma64.CanHavePeripheryDMA64
import chipyard.CNNmod.CanHavePeripheryCNNmod
// ------------------------------------
